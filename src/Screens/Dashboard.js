    ...
    render(){
        return(
            <div>
                ...
                <ModalCheckout modalId="modalCheckout" carts={this.state.carts} />
                <div className="row">
                ...
                <div className="cartnav">
                    <div className="bg-white h-match-parent cart-fix shadow">
                        ...
                        <div className="pr-3 mt-3">
                            ...
                            <div className="pl-4">
                                <button className="btn btn-success btn-sm btn-block mt-1" onClick={() => this.showModalCheckout()}>Checkout</button>
